let simgListe=document.querySelector('#imgListe');
let simgnotif=document.querySelector('#imgnotif');
let simgarchive=document.querySelector('#imgarchive');
let sliste=document.querySelector('#liste');
let srappel=document.querySelector('#rappel');
let sarchive=document.querySelector('#archive');
let sglobalMenuListe=document.querySelector('#globalMenuListe');
let sglobalMenuRappel=document.querySelector('#globalMenuRappel');
...
simgarchive.addEventListener('mouseover',()=>{
sliste.style.display='inline-block';
                srappel.style.display='inline-block';
                sarchive.style.display='inline-block';
                sglobalMenuListe.style.display='inline-block';
...
simgListe.addEventListener('mouseout',()=>{
...
simgnotif.addEventListener('mouseout',()=>{
sliste.style.display='none';
 srappel.style.display='none';
 sarchive.style.display='none';
 sglobalMenuListe.style.boxShadow='0px 0px 0px RGBA(0,0,0,1)';
...
simgarchive.addEventListener('mouseout',()=>{
sliste.style.display='none';
srappel.style.display='none';
sarchive.style.display='none';
sglobalMenuListe.style.boxShadow='0px 0px 0px RGBA(0,0,0,1)';
